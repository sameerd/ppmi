...
# read in part 4. This is for sideeffects of medicine and not used in computing 
# MDS-UPDRS score
...
mds.updrs.pre.3.short <- mds.updrs.pre.3[, c("PATNO", "EVENT_ID", "PART3SCORE")]
...
<<plot-all-mds-updrs, cache=TRUE, echo=TRUE, fig.width=8, fig.height=5>>=
